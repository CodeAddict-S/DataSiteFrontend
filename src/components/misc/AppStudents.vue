<template>
    <template v-if="students">
        ...
        <Table>
            ...
            <TableBody>
                <TableRow v-for="row, index in filteredStudents">
...
const save = () => {
    api.patch(`students/${rowToEdit.value.id}/`, rowToEdit.value).then(() => {
...
const filteredStudents = computed(() => {
    return students.value.filter(s => s?.fullname.toLowerCase()?.match(search.value.toLowerCase()))
})
